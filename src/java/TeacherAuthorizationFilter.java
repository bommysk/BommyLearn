 ...
 * If it is not set then request is being redirected to the teacherLogin.xhml page.
 * 
 * @author skahal
 *
 */
...
public class TeacherAuthorizationFilter implements Filter {
    ...
    public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain) throws ServletException, IOException {    
        ...
        String loginURL = request.getContextPath() + "/teacherLogin.xhtml";

        boolean loggedIn = (session != null) && (session.getAttribute("teacherLogin") != null);
